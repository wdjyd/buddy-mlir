...
define { ptr, ptr, i64, [4 x i64], [4 x i64] } @subgraph0_1(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10) {
  call void @sstcudaSetDevice(i64 0)
  %12 = call ptr @sstcudaMalloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64))
  call void @sstcudaMemcpy(ptr %12, ptr %1, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i1 false)
  %13 = call ptr @sstcudaMalloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64))
  call void @sstcudaMemcpy(ptr %13, ptr @__constant_1x16x8x8xf32, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i1 false)
  %14 = call ptr @sstcudaMalloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64))
  %15 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 1)
  ...
  %16 = call ptr @malloc(i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64))
  ...
  %21 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %20, i64 16, 3, 1
  %22 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %21, i64 8, 3, 2
  %23 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %22, i64 8, 3, 3
  %24 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %23, i64 1024, 4, 0
  %25 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %24, i64 64, 4, 1
  %26 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %25, i64 8, 4, 2
  %27 = insertvalue { ptr, ptr, i64, [4 x i64], [4 x i64] } %26, i64 1, 4, 3
  call void @sstcudaMemcpy(ptr %16, ptr %14, i64 ptrtoint (ptr getelementptr (float, ptr null, i32 1024) to i64), i1 true)
  ret { ptr, ptr, i64, [4 x i64], [4 x i64] } %27
}

define void @_mlir_ciface_subgraph0_1(ptr %0, ptr %1) {
  ...
  %15 = call { ptr, ptr, i64, [4 x i64], [4 x i64] } @subgraph0_1(ptr %4, ptr %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, i64 %14)
