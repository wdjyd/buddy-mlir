...
define { ptr, ptr, i64, [4 x i64], [4 x i64] } @subgraph0_0(ptr %0, ptr %1, i64 %2, i64 %3, i64 %4, i64 %5, i64 %6, i64 %7, i64 %8, i64 %9, i64 %10, ptr %11, ptr %12, i64 %13, i64 %14, i64 %15, i64 %16, i64 %17, i64 %18, i64 %19, i64 %20, i64 %21, ptr %22, ptr %23, i64 %24, i64 %25, i64 %26) {
  ...
  %32 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %32, i64 0, i64 1)
  ...
  %34 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %34, i64 0, i64 2)
  ...
  %36 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %36, i64 0, i64 3)
  ...
  %38 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %38, i64 0, i64 4)
  call void @sstcudaConfigureCall(i64 1, i64 1, i64 1, i64 24, i64 24, i64 6, i64 0)
  call void @sstSetupIntArgument(i64 1, i64 0)
  call void @sstSetupIntArgument(i64 0, i64 8)
  ...
  %39 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %39, i64 0, i64 5)
  call void @sstcudaConfigureCall(i64 1, i64 1, i64 1, i64 24, i64 24, i64 6, i64 0)
  call void @sstSetupIntArgument(i64 1, i64 0)
  call void @sstSetupIntArgument(i64 0, i64 8)
  ...
  %41 = call i64 @__sstcudaRegisterFatBinary(i64 0, i64 0)
  call void @__sstcudaRegisterFunction(i64 %41, i64 0, i64 6)
...
define void @_mlir_ciface_subgraph0_0(ptr %0, ptr %1, ptr %2, ptr %3) {
  ...
  %35 = call { ptr, ptr, i64, [4 x i64], [4 x i64] } @subgraph0_0(ptr %6, ptr %7, i64 %8, i64 %9, i64 %10, i64 %11, i64 %12, i64 %13, i64 %14, i64 %15, i64 %16, ptr %18, ptr %19, i64 %20, i64 %21, i64 %22, i64 %23, i64 %24, i64 %25, i64 %26, i64 %27, i64 %28, ptr %30, ptr %31, i64 %32, i64 %33, i64 %34)
...
declare void @__sstcudaRegisterFunction(i64, i64, i64)
